...
export function addNewPhoto(photo) {
  ...
  return async (dispatch) => {
    ...
    // };
    console.table('addUserPhoto from userAction', photo)
    ...
    .then(photoJSON => {
      ...
      // else {
        ...
        dispatch(userPhotoSuccess(photoJSON.id))
      // }
    })
    .catch(console.error(dispatch(userPhotoActionFailure()),
      console.log,
    )) 
  }
}
